import { DEFAULT_PROMPT_VALUES, ACTION_PRESET_LIST, ACTION_PRESET_MAP, LOCAL_SD_PRESET_LIST, LOCAL_SD_PRESET_MAP, PROMPT_PROVIDER_OPTIONS } from './defaults.js';
...
export function getLocalSdPresetOptions() {
  return LOCAL_SD_PRESET_LIST;
}

export function getLocalSdPreset(presetId) {
  return LOCAL_SD_PRESET_MAP[presetId] || LOCAL_SD_PRESET_MAP.custom;
}
...
export { PROMPT_TEMPLATES, PROMPT_TEMPLATE_LIST, DEFAULT_PROMPT_VALUES, ACTION_PRESET_LIST, ACTION_PRESET_MAP, LOCAL_SD_PRESET_LIST, LOCAL_SD_PRESET_MAP, PROMPT_PROVIDER_OPTIONS };
